export const annotationSources = [{
  ...
  description: 'Live in Paris',
  offset: 110,
  image: 'https://www.freepnglogos.com/uploads/amazon-music-logo-png-14.png',
}, {
  date: new Date(2015, 3, 24),
  description: 'Live in Rome',
  // padding: 0,
  image: 'https://www.freepnglogos.com/uploads/spotify-logo-png/spotify-icon-marilyn-scott-0.png',
}, {
  type: 'text',
  text: 'EuroVision',
  description: 'Live in Lisbon',
